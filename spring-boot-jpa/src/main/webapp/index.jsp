					...
					<form id="taskinfoForm" class="easyui-form" method="post" data-options="novalidate:true">
						<table style="width: 300px;margin: 0 auto;">
							...
							<tr>
								<td>Sex</td>
								<td>
									<input class="easyui-textbox" name="sex" data-options="required:true" style="width:100%">
								</td>
							</tr>
							<tr>
								<td>Time</td>
								<td>
									<input class="easyui-datebox" name="createTime" data-options="required:true" style="width:100%">
